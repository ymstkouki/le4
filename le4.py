...
def main():
    n = Network(10, 50)
    pdir = "C:\\Users\\yamashita kouki\\TensorFlow-MNIST\\mnist\\data\\train-images-idx3-ubyte.gz"
    ldir = "C:\\Users\\yamashita kouki\\TensorFlow-MNIST\\mnist\\data\\train-labels-idx1-ubyte.gz"
    n.read_mnist(pdir, ldir)
    n.param_init()
    n.process()
