...
"""
#最終的な重みをファイルに保存
np.save("W1_issueA1.npy", W1)
np.save("b1_issueA1.npy", b1)
np.save("W2_issueA1.npy", W2)
np.save("b2_issueA1.npy", b2)
"""

#クロスエントロピー誤差を記録
np.save("entropy_ReLU.npy", entropy)
